...
$(document).ready(function(){
    ...
    yesButton.addEventListener('click', () => {
        ...
        responseContainer.innerHTML = '<p style="font-family: Quicksand, sans-serif; color: #2c3e50; font-size: 20px; font-weight: bold;">¡Espero que te haya gustado! Me alegra mucho compartir esto contigo 😊</p>';
